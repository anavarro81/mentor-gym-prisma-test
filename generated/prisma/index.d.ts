...
export namespace Prisma {
  ...
  */
   ...
   * CoachCountOutputType without action
   */
  export type CoachCountOutputTypeCountAthletesArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "email" | "password_hash" | "name" | "profile_picture_url" | "status", ExtArgs["result"]["user"]>
  ...
  export type CoachOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "description" | "rating", ExtArgs["result"]["coach"]>
  ...
  export interface Prisma__CoachClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    athletes<T extends Coach$athletesArgs<ExtArgs> = {}>(args?: Subset<T, Coach$athletesArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$AthletePayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
   ...
   * Coach.athletes
   */
  export type Coach$athletesArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Athlete
     */
    select?: AthleteSelect<ExtArgs> | null
  ...
  export type AthleteOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "height" | "weight" | "birthday" | "Connection_status" | "coachId", ExtArgs["result"]["athlete"]>
  ...
  export interface Prisma__AthleteClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    user<T extends UserDefaultArgs<ExtArgs> = {}>(args?: Subset<T, UserDefaultArgs<ExtArgs>>): Prisma__UserClient<$Result.GetResult<Prisma.$UserPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | Null, Null, ExtArgs, GlobalOmitOptions>
    coach<T extends Athlete$coachArgs<ExtArgs> = {}>(args?: Subset<T, Athlete$coachArgs<ExtArgs>>): Prisma__CoachClient<$Result.GetResult<Prisma.$CoachPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
   ...
   * Athlete.coach
   */
  export type Athlete$coachArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Coach
     */
    select?: CoachSelect<ExtArgs> | null
  ...
  export type CoachCreateNestedOneWithoutAthletesInput = {
    create?: XOR<CoachCreateWithoutAthletesInput, CoachUncheckedCreateWithoutAthletesInput>
  ...
  export type CoachUpdateOneWithoutAthletesNestedInput = {
    ...
    delete?: CoachWhereInput | boolean
    connect?: CoachWhereUniqueInput
    update?: XOR<XOR<CoachUpdateToOneWithWhereWithoutAthletesInput, CoachUpdateWithoutAthletesInput>, CoachUncheckedUpdateWithoutAthletesInput>
  }
  ...
  export type CoachUpsertWithoutAthletesInput = {
    update: XOR<CoachUpdateWithoutAthletesInput, CoachUncheckedUpdateWithoutAthletesInput>
    create: XOR<CoachCreateWithoutAthletesInput, CoachUncheckedCreateWithoutAthletesInput>
    where?: CoachWhereInput
  }
  ...
  export type CoachUpdateToOneWithWhereWithoutAthletesInput = {
    where?: CoachWhereInput
    data: XOR<CoachUpdateWithoutAthletesInput, CoachUncheckedUpdateWithoutAthletesInput>
  }
